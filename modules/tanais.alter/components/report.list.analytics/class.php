...
class reportList extends CBitrixComponent
{
    ...
    {
        $reports['Визит регионального менеджера'][] = [
            'NAME' => '<i class="fa-light fa-person-simple"></i> Отчёт по сотрудникам',
            'URL' => '/alter/report/specialists/',
            'FILE' => MODULE_PATH . '/public/report/specialists/index.php',
        ];
