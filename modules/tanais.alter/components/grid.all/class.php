...
class GridExportComponent extends CBitrixComponent
{
    ...
    public function executeComponent()
    {
        ...
        $hlblock = \Bitrix\Highloadblock\HighloadBlockTable::getById(self::LOG_HIGHLOADBLOCK_ID)->fetch();
