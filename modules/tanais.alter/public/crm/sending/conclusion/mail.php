...
<?php
    ...
    if ($labaratory == 'milk' || $labaratory == 'milkEKB') {
        ...
        if ((($trySour >= $tryMade) || ($complexSouring == '1')) && ($tryMade != 0)):
            ...
            $bodySend .= '<p>Обращаем внимание, что часть проб поступила с признаками скисания. Рекомендуем Вам провести мойку пробоотборников щелочными и кислотными растворами, и охлаждать пробы перед отправкой. <a href="https://disk.yandex.ru/i/NfAuo4GvKQKOiw" target="_blank">Рекомендации по предотвращении скисания проб молока.</a> </p><br>';
        endif;
